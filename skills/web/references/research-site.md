...
4. Competing explanation, limitation, or boundary.
5. Practical implication and invalidation condition.

Use an evidence matrix, comparison, timeline, or dependency view only when it matches the information topology. Interaction should help the reader compare evidence or trace a claim; it must not hide the core argument.

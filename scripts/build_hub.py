...
def build_pages():
    ...
    entries = '''<section class="entry-strip" aria-label="Choose your purpose"><a href="/hub/solutions/"><span>01 / APPLY</span><strong>Solve a problem ↗</strong><small>Capabilities & project inquiries</small></a><a href="/hub/collaborate/"><span>02 / INVESTIGATE</span><strong>Research together ↗</strong><small>Proposals, methods & open questions</small></a><a href="/hub/experience/"><span>03 / EVALUATE</span><strong>Explore my work ↗</strong><small>Systems, decisions & source material</small></a><a href="/hub/library/"><span>04 / LEARN</span><strong>Follow an idea ↗</strong><small>Writing, skills & interactive research</small></a></section>'''
    ...
    solutions=head('WORK WITH ME','Start with the problem you need to solve.','Explore relevant systems and discuss a scoped engagement. Public research remains freely readable; commercial terms are agreed separately.')+'<div class="offer-grid">'+offers+'</div>'
    write('hub/solutions/index.html',page('Work with me','Explore AI workflow, evaluation, and knowledge systems engagements.',solutions,'/hub/solutions/'))
    collaborate=head('RESEARCH & COLLABORATE','Good questions deserve shared work.','Explore the hypothesis, inspect the protocol, and bring a question or an experiment. Research proposals are distinguished from completed results.')+'''<section class="reading-path"><p class="eyebrow">START HERE / GUARDED SKILL EVOLUTION</p><h2>From a research question to an evaluation design.</h2><ol>'''+''.join(f'<li><a href="{detail(BY_ID[i])}">{E(BY_ID[i]["title"])} ↗</a></li>' for i in ['gse','gse-paper','gse-experiment-protocol','gse-benchmark-schema'])+'''</ol><p>Potential collaboration: critique the protocol, propose evaluation tasks, or discuss an independent implementation. Simulator values are illustrative; they are not completed experimental findings.</p><a class="button" href="/hub/contact/?purpose=Research%20collaboration">Propose a collaboration ↗</a></section>'''+section('Explore research', ''.join(card(a) for a in ASSETS if a['kind']=='Research'), '<a href="/hub/library/?kind=Protocol">Read protocols ↗</a>')
    write('hub/collaborate/index.html',page('Research & collaborate','Explore proposals, protocols, interactive explainers, and collaboration opportunities.',collaborate,'/hub/collaborate/'))
